...
{
    public class StockOutOrderListPageViewModel : ObservableObject
    {
        ...
        public StockOutOrderListPageViewModel(INavigation navitation)
        {
        ...
        public void LoadData()
        {
            ...
            MainThread.BeginInvokeOnMainThread(async () =>
            {
                ...
                TransactionPageModel_result _rtn = await MainApiService.Instance.Transaction.StockOutListing(data);
